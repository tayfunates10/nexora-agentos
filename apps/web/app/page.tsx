...
export default async function Home() {
  ...
  return <main>
    <header><a href="/" className="brand"><span className="mark">N</span> NEXORA <span className="muted">/ AgentOS</span></a><span className="badge">Foundation · v0.1</span></header>
    ...
    <section className="next" aria-labelledby="next-title"><div><p className="eyebrow">NEXT MILESTONE</p><h2 id="next-title">Workspaces & access control</h2><p>Authentication, workspace membership and authorization come before agent execution.</p></div><span className="badge">Planned</span></section>
